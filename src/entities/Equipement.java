...
public class Equipement {
    ...
    public Equipement( int typequipement_e, String name_e, String marque_e, String description_e,int id_e, String image_e, float prix_e) {
        this.id_e = id_e;
        this.name_e = name_e;
    ...
    public Equipement(String name_e, String marque_e, String description_e, String image_e, float prix_e) {
        this.name_e = name_e;
        this.marque_e = marque_e;
        this.description_e = description_e;
        this.image_e = image_e;
